...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    if(!newUser) {
      return toast({
        title: "Error signing up to Omniscient. Please try again."
      })
    }
    ...
    if(!session) {
      return toast({ title: 'Sing-in Session Failed. Please try again...'})
    }
  ...
  return (
      ...
      <Form {...form}>
        ...
        <div className="sm:w-420 flex-center flex-col">
          ...
          <p className="text-light-3 small-medium md:base-regular mt-2">enter your details below to join Omniscient
          </p>
